...
import com.alibaba.graphscope.proto.GraphTypePb;
import com.alibaba.graphscope.proto.GrootInfoPb;
...
public class GrootDdlService extends GrootDdlServiceGrpc.GrootDdlServiceImplBase {
    private static final Logger logger = LoggerFactory.getLogger(GrootDdlService.class);
